...
class RegPage(BasePage):
    ...
    def registration_with_valid_data(self, first_name, last_name, email_phone, password, region):
        ...
        self.find_element(RegPageLocators.REG_REGION_INPUT).send_keys(region)
