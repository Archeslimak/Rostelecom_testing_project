...
class AuthPageLocators:
    ...
    AUTH_PRIVACY_POLICY_LINK = (By.XPATH, "/html/body/div[1]/footer/div[1]/div[2]/a[2]")
    #AUTH_SOCIAL_VK_LINK = (By.XPATH, "//a[@id='oidc_vk']")
    AUTH_SOCIAL_VK_LINK = (By.XPATH, "/html/body/div[1]/main/section[2]/div/div[1]/div/form/div[5]/div[2]/a[3]")
...
class ChangePassPageLocators:
    ...
    CHANGE_PASS_PRIVACY_POLICY_LINK = (By.XPATH, "/html/body/div[1]/footer/div[1]/div[2]/a[2]")
...
class RegPageLocators:
    ...
    REG_REGION_INPUT = (By.XPATH, "/html/body/div[1]/main/section[2]/div/div[1]/div/form/div[2]/div/div/input")
    REG_ENTER_BUTTON = (
    ...
    REG_PRIVACY_POLICY_LINK = (By.XPATH, "/html/body/div[1]/footer/div[1]/div[2]/a[2]")
    REG_ERROR_PASSWORD_DONT_MATCH = (By.XPATH, "//span[contains(text(),'Пароли не совпадают')]")

class EmailConfirmPageLocators:
    #EMAIL_CONF_HEADING = (By.XPATH, "/html/body/div[1]/main/section[2]/div/div/h1")
